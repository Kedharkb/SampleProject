...
!function () {
        ...
        var e = {
            ...
            link: function (b, e, f, g) {
                ...
                d.initialize(b, g), b.defaultMenuItems = d.getDefaultMenuItems(b), b.menuItems = b.defaultMenuItems, d.setColMenuItemWatch(b), b.showMenu = function (a, c, f) {
                    ...
                    b.col.colDef.visible = !1, b.grid.refresh(), b.hideMenu(), b.grid.api.core.notifyDataChange(c.dataChange.COLUMN)
                }
            },
            ...
            compile: function () {
                return {
                    pre: function (a, c, g, h) {
                        var i = h[0], j = h[1];
                        a.grid = i.grid, a.colContainer = j.colContainer, j.header = c, j.colContainer.header = c;
                        var k;
                        k = a.grid.options.showHeader ? a.grid.options.headerTemplate ? a.grid.options.headerTemplate : e : f, d.getTemplate(k).then(function (d) {
                            var e = angular.element(d), f = b(e)(a);
                        ...
                        function f() {
                            var a = h.colContainer.getViewportWidth(), b = h.colContainer.visibleColumnCache, c = 0, e = 0, f = 0, g = a, i = !1, j = function (b) {
                            ...
                            b.forEach(function (a) {
                                a.widthType = null, isFinite(+a.width) ? a.widthType = "manual" : d.endsWith(a.width, "%") ? (a.widthType = "percent", i = !0) : angular.isString(a.width) && -1 !== a.width.indexOf("*") && (a.widthType = "auto", e += a.width.length, i = !0)
                            });
                            var k = ["manual", "percent", "auto"];
                            if (b.filter(function (a) {
                                    return a.visible && a.widthType
                                }).sort(function (a, b) {
                                    return k.indexOf(a.widthType) - k.indexOf(b.widthType)
                                }).forEach(function (a) {
                                    var b = j(a);
                                ...
                                do m = g, b.forEach(l); while (g > 0 && g !== m)
                            }
                            c = Math.max(c, a);
                            var n = "";
                            return b.forEach(function (a) {
                                n += a.getColClassDefinition()
                            }), b.length > 0 && (b[b.length - 1].headerWidth = b[b.length - 1].drawnWidth - 30), h.colContainer.canvasWidth = parseInt(c, 10), n
                        }
                        ...
                        i && (h.headerViewport = i), g && g.grid.registerStyleComputation({priority: 5, func: f})
                    }
                }
            }
        }
    ...
    angular.module("ui.grid").service("uiGridGridMenuService", ["gridUtil", "i18nService", "uiGridConstants", function (a, b, c) {
        var d = {
            initialize: function (a, b) {
                ...
                a.colDef.visible = !(a.colDef.visible === !0 || void 0 === a.colDef.visible), a.grid.refresh(), a.grid.api.core.notifyDataChange(c.dataChange.COLUMN)
            }
        };
        return d
        ...
        return {
            ...
            compile: function () {
                return {
                    pre: function (a, b, c, d) {
                    ...
                    }, post: function (a, c, f, g) {
                        function h(b) {
                            if (!b.grid || b.grid.id === n.id) {
                                if (b.y && a.bindScrollVertical) {
                                    m.prevScrollArgs = b;
                                    var c = b.getNewScrollTop(o, m.viewport);
                                    (b.source !== e.Sources.ViewPortScroll || b.sourceColContainer !== p) && (m.viewport[0].scrollTop = c)
                                }
                                if (b.x && a.bindScrollHorizontal) {
                                    m.prevScrollArgs = b;
                                    var f = b.getNewScrollLeft(p, m.viewport);
                                    a.newScrollLeft = f, m.headerViewport && (m.headerViewport.scrollLeft = d.denormalizeScrollLeft(m.headerViewport, f)), m.footerViewport && (m.footerViewport.scrollLeft = d.denormalizeScrollLeft(m.footerViewport, f)), b.source !== e.Sources.ViewPortScroll && (m.viewport[0].scrollLeft = f), m.prevScrollLeft = f
                                }
                            }
                        }
                        ...
                        function i(a) {
                            ...
                            var b, c, d, f;
                            d = a.targetTouches[0].screenX, f = a.targetTouches[0].screenY, b = -(d - t), c = -(f - s), w = 1 > c ? -1 : 1, x = 1 > b ? -1 : 1, c *= 2, b *= 2;
                            var g = new e(n, o, p, e.Sources.RenderContainerTouchMove);
                            if (0 !== c) {
                                var h = (u + c) / o.getVerticalScrollLength();
                                h > 1 ? h = 1 : 0 > h && (h = 0), g.y = {percentage: h, pixels: c}
                            }
                            if (0 !== b) {
                                var i = (v + b) / (p.getCanvasWidth() - p.getViewportWidth());
                                i > 1 ? i = 1 : 0 > i && (i = 0), g.x = {percentage: i, pixels: b}
                            }
                            g.fireScrollingEvent()
                        }

                        function j(a) {
                            a.originalEvent && (a = a.originalEvent), b.unbind("touchmove", i), b.unbind("touchend", j), b.unbind("touchcancel", j);
                            {
                                var c = m.viewport[0].scrollTop, d = m.viewport[0].scrollTop;
                                Math.abs(c - u), Math.abs(d - v), new Date - r
                            }
                        }

                        function k() {
                            var b = "", c = p.getCanvasWidth(), d = p.getViewportWidth(), e = o.getCanvasHeight();
                            "body" !== a.containerId && (e += n.scrollbarHeight);
                            var f = o.getViewportHeight(), g = p.getHeaderViewportWidth(), h = p.getHeaderViewportWidth();
                            return b += "\n .grid" + l.grid.id + " .ui-grid-render-container-" + a.containerId + " .ui-grid-canvas { width: " + c + "px; height: " + e + "px; }", b += "\n .grid" + l.grid.id + " .ui-grid-render-container-" + a.containerId + " .ui-grid-header-canvas { width: " + (c + n.scrollbarWidth) + "px; }", b += "\n .grid" + l.grid.id + " .ui-grid-render-container-" + a.containerId + " .ui-grid-viewport { width: " + d + "px; height: " + f + "px; }", b += "\n .grid" + l.grid.id + " .ui-grid-render-container-" + a.containerId + " .ui-grid-header-viewport { width: " + g + "px; }", b += "\n .grid" + l.grid.id + " .ui-grid-render-container-" + a.containerId + " .ui-grid-footer-canvas { width: " + c + n.scrollbarWidth + "px; }", b += "\n .grid" + l.grid.id + " .ui-grid-render-container-" + a.containerId + " .ui-grid-footer-viewport { width: " + h + "px; }", void 0 !== q.explicitHeaderHeight && null !== q.explicitHeaderHeight && q.explicitHeaderHeight > 0 ? b += "\n .grid" + l.grid.id + " .ui-grid-render-container-" + a.containerId + " .ui-grid-header-cell { height: " + q.explicitHeaderHeight + "px; }" : void 0 !== q.innerHeaderHeight && null !== q.innerHeaderHeight && q.innerHeaderHeight > 0 && (b += "\n .grid" + l.grid.id + " .ui-grid-render-container-" + a.containerId + " .ui-grid-header-cell { height: " + q.innerHeaderHeight + "px; }"), b
                        }

                        var l = g[0], m = g[1], n = l.grid, o = m.rowContainer, p = m.colContainer, q = n.renderContainers[a.containerId];
                        c.addClass("ui-grid-render-container-" + a.containerId), (a.bindScrollHorizontal || a.bindScrollVertical) && n.api.core.on.scrollEvent(a, h), c.bind("wheel mousewheel DomMouseScroll MozMousePixelScroll", function (a) {
                            var b = d.normalizeWheelEvent(a), c = new e(n, o, p, e.Sources.RenderContainerMouseWheel);
                            if (0 !== b.deltaY) {
                                var f = -120 * b.deltaY, g = (m.viewport[0].scrollTop + f) / o.getVerticalScrollLength();
                                0 > g ? g = 0 : g > 1 && (g = 1), c.y = {percentage: g, pixels: f}
                            }
                            if (0 !== b.deltaX) {
                                var h = -120 * b.deltaX, i = d.normalizeScrollLeft(m.viewport), j = (i + h) / (p.getCanvasWidth() - p.getViewportWidth());
                                0 > j ? j = 0 : j > 1 && (j = 1), c.x = {percentage: j, pixels: h}
                            }
                            (c.y && 0 !== c.y.percentage && 1 !== c.y.percentage && 0 !== m.viewport[0].scrollTop || c.x && 0 !== c.x.percentage && 1 !== c.x.percentage) && a.preventDefault(), c.fireThrottledScrollingEvent()
                        });
                        var r, s = 0, t = 0, u = 0, v = 0, w = 1, x = 1;
                        d.isTouchEnabled() && c.bind("touchstart", function (a) {
                            a.originalEvent && (a = a.originalEvent), l.scrollbars.forEach(function (a) {
                                a.addClass("ui-grid-scrollbar-visible"), a.addClass("ui-grid-scrolling")
                            }), r = new Date, s = a.targetTouches[0].screenY, t = a.targetTouches[0].screenX, u = m.viewport[0].scrollTop, v = m.viewport[0].scrollLeft, b.on("touchmove", i), b.on("touchend touchcancel", j)
                        }), c.bind("$destroy", function () {
                            c.unbind("keydown"), ["touchstart", "touchmove", "touchend", "keydown", "wheel", "mousewheel", "DomMouseScroll", "MozMousePixelScroll"].forEach(function (a) {
                                c.unbind(a)
                            })
                        }), l.grid.registerStyleComputation({priority: 6, func: k})
                    }
                }
            }
        }
    ...
    "use strict";
    angular.module("ui.grid").directive("uiGridViewport", ["gridUtil", "ScrollEvent", function (a, b) {
        return {
            replace: !0,
            scope: {},
            ...
            link: function (c, d, e, f) {
                var g = f[0], h = f[1];
                c.containerCtrl = h;
                var i = h.rowContainer, j = h.colContainer, k = g.grid;
                c.grid = g.grid, c.rowContainer = h.rowContainer, c.colContainer = h.colContainer, h.viewport = d, d.on("scroll", function () {
                    var c = d[0].scrollTop, e = a.normalizeScrollLeft(d), f = -1, g = -1;
                    if (e !== j.prevScrollLeft) {
                        k.flagScrollingHorizontally();
                        var h = (e - j.prevScrollLeft, j.getCanvasWidth() - j.getViewportWidth());
                        f = 0 !== h ? e / h : 0, j.adjustScrollHorizontal(e, f)
                    }
                    if (c !== i.prevScrollTop) {
                        k.flagScrollingVertically();
                        var l = (c - i.prevScrollTop, i.getVerticalScrollLength());
                        g = c / l, g > 1 && (g = 1), 0 > g && (g = 0), i.adjustScrollVertical(c, g)
                    }
                    var m = new b(k, i, j, b.Sources.ViewPortScroll);
                    m.newScrollLeft = e, m.newScrollTop = c, f > -1 && (m.x = {percentage: f}), g > -1 && (m.y = {percentage: g}), m.fireScrollingEvent()
                })
            }
        }
    }])
    ...
    angular.module("ui.grid").factory("Grid", ["$q", "$compile", "$parse", "gridUtil", "uiGridConstants", "GridOptions", "GridColumn", "GridRow", "GridApi", "rowSorter", "rowSearcher", "GridRenderContainer", "$timeout", function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
        ...
        return o.prototype.calcFooterHeight = function () {
            ...
            for (var b in a.renderContainers) {
                var c = a.renderContainers[b];
                c.adjustRows(null, c.prevScrolltopPercentage), c.adjustColumns(null, c.prevScrollleftPercentage)
            }
    ...
    angular.module("ui.grid").factory("GridRenderContainer", ["gridUtil", "uiGridConstants", function (a, b) {
        ...
        return c.prototype.reset = function () {
            ...
            "undefined" != typeof b && null !== b || !a || (b = a / c.getVerticalScrollLength());
            ...
            var b, c = this, d = [], e = [], f = 0, g = c.getViewportWidth(), h = 0, i = 0, j = "", k = c.visibleColumnCache;
    ...
    b.service("rowSearcher", ["gridUtil", "uiGridConstants", function (b, c) {
        ...
        return e.getTerm = function (a) {
            ...
            for (var b = [], d = a.length, f = 0; d > f; f++) {
                ...
                if (g.noTerm || g.term) {
                    var h = {}, i = "";
                    g.flags && g.flags.caseSensitive || (i += "i"), g.term && (h.term = e.stripTerm(g)), h.condition = g.condition ? g.condition : e.guessCondition(g), h.flags = angular.extend({caseSensitive: !1}, g.flags), h.condition === c.filter.STARTS_WITH && (h.startswithRE = new RegExp("^" + h.term, i)), h.condition === c.filter.ENDS_WITH && (h.endswithRE = new RegExp(h.term + "$", i)), h.condition === c.filter.CONTAINS && (h.containsRE = new RegExp(h.term, i)), h.condition === c.filter.EXACT && (h.exactRE = new RegExp("^" + h.term + "$", i)), b.push(h)
                }
            }
            return b
            ...
            return e.condition === c.filter.GREATER_THAN ? h > g : e.condition === c.filter.GREATER_THAN_OR_EQUAL ? h >= g : e.condition === c.filter.LESS_THAN ? g > h : e.condition === c.filter.LESS_THAN_OR_EQUAL ? g >= h : !0
            ...
            if (b) {
                for (var d = [], f = c.length, g = 0; f > g; g++) {
                    var h = c[g];
                    "undefined" != typeof h.filters && (h.filters.length > 1 || 1 === h.filters.length && h.filters[0].term) ? d.push({
                        col: h,
    ...
    b.constant("uiGridCellNavConstants", {
        ...
        var g = {
            initializeGrid: function (a) {
                ...
                var e = null, f = null;
                null !== c && "undefined" != typeof c && (e = a.getRow(c)), null !== d && "undefined" != typeof d && (f = a.getColumn(d.name ? d.name : d.field)), this.scrollToInternal(a, b, e, f)
            }, scrollToFocus: function (a, b, c, d) {
                var e = null, f = null;
                null !== c && (e = a.getRow(c)), null !== d && (f = a.getColumn(d.name ? d.name : d.field)), this.scrollToInternal(a, b, e, f);
                var g = {row: e, col: f};
                a.cellNav.broadcastCellNav(g)
            }, scrollToInternal: function (a, b, c, d) {
                var e = new f(a, null, null, "uiGridCellNavService.scrollToInternal");
                if (null !== c) {
                    var g = a.renderContainers.body.visibleRowCache.indexOf(c), h = a.renderContainers.body.visibleRowCache.length, i = (g + g / (h - 1)) / h;
                    e.y = {percentage: i}
                }
                null !== d && (e.x = {percentage: this.getLeftWidth(a, d) / this.getLeftWidth(a, a.renderContainers.body.visibleColumnCache[a.renderContainers.body.visibleColumnCache.length - 1])}), (e.y || e.x) && e.fireScrollingEvent()
            }, scrollToIfNecessary: function (a, b, c, d) {
                var e = new f(a, null, null, "uiGridCellNavService.scrollToIfNecessary"), g = a.renderContainers.body.visibleRowCache, h = a.renderContainers.body.visibleColumnCache, i = a.renderContainers.body.prevScrollTop + a.headerHeight;
                i = 0 > i ? 0 : i;
                var j = a.renderContainers.body.prevScrollLeft, k = a.renderContainers.body.prevScrollTop + a.gridHeight - a.headerHeight, l = a.renderContainers.body.prevScrollLeft + a.gridWidth;
                if (null !== c) {
                    var m = g.indexOf(c), n = a.renderContainers.body.getCanvasHeight() - a.renderContainers.body.getViewportHeight(), o = (m + 1) * a.options.rowHeight;
                    o = 0 > o ? 0 : o;
                    var p, q;
                    i > o ? (p = a.renderContainers.body.prevScrollTop - (i - o), q = p / n, e.y = {percentage: q}) : o > k && (p = o - k + a.renderContainers.body.prevScrollTop, q = p / n, e.y = {percentage: q})
                }
                if (null !== d) {
                    for (var r = h.indexOf(d), s = a.renderContainers.body.getCanvasWidth() - a.renderContainers.body.getViewportWidth(), t = 0, u = 0; r > u; u++) {
                        var v = h[u];
                        t += v.drawnWidth
                    }
                    t = 0 > t ? 0 : t;
                    var w = t + d.drawnWidth;
                    w = 0 > w ? 0 : w;
                    var x, y;
                    j > t ? (x = a.renderContainers.body.prevScrollLeft - (j - t), y = x / s, y = y > 1 ? 1 : y, e.x = {percentage: y}) : w > l && (x = w - l + a.renderContainers.body.prevScrollLeft, y = x / s, y = y > 1 ? 1 : y, e.x = {percentage: y})
                }
                (e.y || e.x) && e.fireScrollingEvent()
                ...
                return {
                    pre: function (b, e, f, g) {
                        ...
                        c.initializeGrid(i), g.cellNav = {}, g.cellNav.focusCell = function (a, b) {
                            ...
                            var h = g.grid.api.cellNav.getFocusedCell();
                            if (h) {
                                var j = g.grid.renderContainers[f].cellNav.getNextRowCol(e, h.row, h.col);
                                return j.eventType = d.EVENT_TYPE.KEYDOWN, g.cellNav.broadcastCellNav(j), c.scrollToIfNecessary(i, b, j.row, j.col), a.stopPropagation(), a.preventDefault(), !1
                            }
                        }
                    }, post: function () {
                    }
                    ...
                    post: function (c, d, f, g) {
                        ...
                        if (h.grid.api.cellNav) {
                            ...
                            k.api.core.on.scrollEvent(c, function (c) {
                                c.grid && c.grid.id !== h.grid.id || null != h.grid.api.cellNav.getFocusedCell() && ("uiGridCellNavService.scrollToIfNecessary" === c.source ? l = !0 : a(l ? function () {
                                    a(function () {
                                        var a = h.grid.api.cellNav.getFocusedCell();
                                        b.activeElement === b.body && d[0].focus(), h.cellNav.broadcastCellNav(a), l = !1
                                    })
                                } : function () {
                                    var a = {col: {uid: null}, row: {uid: null}};
                                    h.cellNav.broadcastCellNav(a)
                                }))
                            })
                        }
                    }
    ...
    a.constant("uiGridEditConstants", {
        ...
        return {
            priority: -100, restrict: "A", scope: !1, require: "?^uiGrid", link: function (f, j, k, l) {
                ...
                function t() {
                    if (!C && s(f.col, f.row)) {
                        f.grid.api.cellNav && f.grid.api.cellNav.scrollToIfNecessary(f, f.row, f.col), z = g(f.row.getQualifiedColField(f.col)), y = z(f), x = f.col.editableCellTemplate, x = x.replace(d.MODEL_COL_FIELD, f.row.getQualifiedColField(f.col));
    ...
    }]), a.directive("uiGridViewport", ["$compile", "gridUtil", "uiGridInfiniteScrollService", "uiGridConstants", function (a, b, c) {
        return {
            priority: -200, scope: !1, link: function (a) {
                a.grid.options.enableInfiniteScroll && a.grid.api.core.on.scrollEvent(a, function (b) {
                    if (b.y) {
                        var d = 100 - 100 * b.y.percentage;
                        c.checkScroll(a.grid, d)
                    }
                })
            }
        }
            ...
            initializeGrid: function (b) {
                ...
                angular.forEach(b, function (b, c) {
                    ...
                    if (d.length > 0) {
                        ...
                        if (a.columns[e].visible = b.visible, a.columns[e].colDef.visible = b.visible, a.columns[e].width = b.width, a.columns[e].sort = angular.copy(b.sort), a.columns[e].filters = angular.copy(b.filters), e !== c) {
                ...
                if (b.api.cellNav) {
                    ...
                    (e || h) && (d.focus ? b.api.cellNav.scrollToFocus(c, h, e) : b.api.cellNav.scrollTo(c, h, e))
                }
