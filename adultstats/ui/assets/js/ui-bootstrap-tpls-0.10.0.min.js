...
.provider( '$tooltip', function () {
  ...
  this.$get = [ '$window', '$compile', '$timeout', '$parse', '$document', '$position', '$interpolate', function ( $window, $compile, $timeout, $parse, $document, $position, $interpolate ) {
    return function $tooltip ( type, prefix, defaultTriggerShow ) {
      ...
      var template = 
        '<div ng-mouseleave="hideTemplate()" '+ directiveName +'-popup '+
          'title="'+startSym+'tt_title'+endSym+'" '+
          'heading="'+startSym+'tt_heading'+endSym+'" '+
          'content="'+startSym+'tt_content'+endSym+'" '+
          'placement="'+startSym+'tt_placement'+endSym+'" '+
          'customclass="'+startSym+'tt_customclass'+endSym+'" '+
      ...
      return {
        ...
        compile: function (tElem, tAttrs) {
          ...
          return function link ( scope, element, attrs ) {
            ...
            attrs.$observe( prefix+'Heading', function ( val ) {
              scope.tt_heading = val;
            });
            ...
            attrs.$observe( prefix+'Customclass', function ( val ) {
              scope.tt_customclass = val;
            });
            ...
            {
                if(angular.isDefined( (attrs[prefix + 'Toggle'] )))
                {
                   // scope[attrs[prefix + 'Toggle']] = false; 
                }
 //               else
//                {
//                     $timeout(hide);
...
.directive( 'popoverTemplatePopup', [ '$http', '$templateCache', '$compile', '$timeout', function ( $http, $templateCache, $compile, $timeout ) {
  return {
    restrict: 'EA',
    replace: true,
    scope: { title: '@', heading: '@', content: '@', placement: '@',customclass:'@', animation: '&', isOpen: '&', compileScope: '&' },
...
angular.module("template/popover/popover-template.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/popover/popover-template.html",
    "<div class=\"popover {{placement}} {{customclass}}\" ng-class=\"{ in: isOpen(), fade: animation() }\">\n" +
    "  <div class=\"arrow\"></div>\n" +
    "\n" +
    "  <div class=\"popover-inner\">\n" +
